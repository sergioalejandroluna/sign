...
const docs=[
  {id:1,date: '1999-12-11', folio: 'ADS/756/H67', to: randomUser().name.full, from: randomUser().name.full, body:initialBody , created_by: randomUser().name.full},
  {id:2,date: '1990-11-12', folio: 'DFG/285/Y56', to: randomUser().name.full, from: randomUser().name.full, body:initialBody , created_by: randomUser().name.full},
  {id:3,date: '1991-10-13', folio: 'RTH/552/R51', to: randomUser().name.full, from: randomUser().name.full, body:initialBody , created_by: randomUser().name.full},
  {id:4,date: '1992-09-14', folio: 'DVU/104/A34', to: randomUser().name.full, from: randomUser().name.full, body:initialBody , created_by: randomUser().name.full},
]
module.exports = () => {
