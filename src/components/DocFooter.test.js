...
it('should have a street', function() {
  expect(wrapper.find(Grid).get(11).props.children).toBe(address.street)
})
it('should have a colony', function() {
  expect(wrapper.find(Grid).get(12).props.children).toBe(address.colony)
})
it('should have a city', function() {
  expect(wrapper.find(Grid).get(13).props.children).toBe(address.city)
})
it('should have a city', function() {
  expect(wrapper.find(Grid).get(14).props.children).toBe(address.zip)
})
